...
- [ ] **P7b Remaining design list**: the push-your-luck die is only a damage band (no press-your-luck escalation). Positioning is now fully playable (row swap + the `backRowMeleeMult` mitigation in `DamagePipeline` step 4b).
